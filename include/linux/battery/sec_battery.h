...
#define STORE_MODE_CHARGING_MAX_VALUE 35
#define STORE_MODE_CHARGING_MIN_VALUE 30
#else
#define STORE_MODE_CHARGING_MAX_VALUE 70
#define STORE_MODE_CHARGING_MIN_VALUE 60
#endif
